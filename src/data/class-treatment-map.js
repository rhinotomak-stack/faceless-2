...
// allowedMGs[]         — fullscreen and overlay MG types that make sense for this class
...
const CLASS_TREATMENTS = {
    'actor-event': {
        ...
        allowedMGs: ['lowerThird', 'headline', 'broadcastLogo'],
    ...
    'location-event': {
        ...
        alternates: ['footage'],
        blocked: [],
        allowedMGs: ['headline', 'mapChart'],
        allowedTemplates: ['locationCard', 'factCard', 'splitScreen'],
    ...
    'data-claim': {
        ...
        alternates: ['template'],
        blocked: ['concept-metaphor'],
        allowedMGs: ['barChart', 'donutChart', 'rankingList', 'timeline', 'comparisonCard', 'bulletList', 'statCounter', 'dataBar', 'percentageCircle', 'focusWord'],
        allowedTemplates: ['statCard', 'comparisonCard', 'infographic', 'factCard'],
        preferredSource: 'stock',
    ...
    'quote-callout': {
        ...
        alternates: ['template'],
        blocked: [],
        allowedMGs: ['callout', 'focusWord', 'kineticText', 'typographyReveal', 'headline'],
    ...
    'concept-metaphor': {
        ...
        alternates: ['template'],
        blocked: ['footage'],
        allowedMGs: ['focusWord', 'kineticText', 'typographyReveal', 'callout'],
        allowedTemplates: ['keyTakeaway', 'timelineCard', 'comparisonCard', 'factCard', 'imageShowcase'],
        preferredSource: 'stock',
        defaultRetrievability: 'internal-only',
    },
    'transition-bridge': {
        ...
        alternates: ['graphics'],
        blocked: [],
        allowedMGs: ['focusWord', 'kineticText'],
        allowedTemplates: [],
        preferredSource: 'stock',
        defaultRetrievability: 'easy',
    },
    'hook-tease': {
        ...
        alternates: ['graphics'],
        blocked: [],
        allowedMGs: ['headline', 'focusWord', 'kineticText', 'callout'],
...
function resolvePreferredSource(preferredSourceKey, nicheId) {
    ...
    switch (preferredSourceKey) {
        case 'news-actor':
            source = isNews ? 'youtube' : 'youtube';
            break;
        case 'news-location':
            source = isNews ? 'youtube' : 'web-image';
            break;
        case 'stock':
            source = 'stock';
            break;
        ...
        case 'reddit':
            ...
            break;
        default:
            source = preferredSourceKey;
    }
    return sanitizeSourceHint(source, 'youtube');
}
